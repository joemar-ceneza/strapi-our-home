...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    regPrice: Attribute.Decimal & Attribute.DefaultTo<0>;
    salePrice: Attribute.Decimal & Attribute.DefaultTo<0>;
    isBSeller: Attribute.Boolean & Attribute.DefaultTo<false>;
